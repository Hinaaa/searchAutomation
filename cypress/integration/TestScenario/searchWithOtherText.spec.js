 ...
 describe('Testcase to search with text other than Apollo 11', function ()  {
    before(() => {
 ...
 function execute(data) {
     prodSelection.searchText(data.searchTextData)
  sel.getTextHeading().should('have.text', data.searchTextData)//Searched text should appear
  sel.getTextHeading().should('not.have.text', 'Apollo 11') //otherText, not searched
 }
