...
describe('Testcase to search with similar incomplete text', function ()  {
    before(() => {
...
prodSelection.searchPartialTextAndClick(data.partialSearchText, data.searchTextData) //pass two variable, one with partial keyword and other with actual text to search
